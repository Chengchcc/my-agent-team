...
const BLOCKED_PREFIXES = ["127.", "10.", "192.168.", "172.16.", "172.17.", "172.18.", "172.19.", "172.20.", "172.21.", "172.22.", "172.23.", "172.24.", "172.25.", "172.26.", "172.27.", "172.28.", "172.29.", "172.30.", "172.31."];

function isPrivateIP(hostname: string): boolean {
  if (BLOCKED_HOSTS.has(hostname)) return true;
  if (hostname.startsWith("[")) return hostname === "[::1]" || hostname.startsWith("[fc") || hostname.startsWith("[fd");
