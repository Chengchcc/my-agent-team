        ...
        data.tokenSeries.length === 0 ? (
          ...
          <ChartContainer config={chartConfig} className="h-[220px] w-full">
            <AreaChart accessibilityLayer data={data.tokenSeries} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="input" stroke="var(--color-input)" fill="var(--color-input)" fillOpacity={0.1} strokeWidth={2} />
              <Area type="monotone" dataKey="output" stroke="var(--color-output)" fill="var(--color-output)" fillOpacity={0.1} strokeWidth={2} />
            </AreaChart>
          </ChartContainer>
        )
      }
